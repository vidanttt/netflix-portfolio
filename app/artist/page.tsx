...
const projects: CreativeProject[] = [
	{
		...
		description: "Educational video series breaking down complex technology concepts for everyday users",
		type: "Video",
		platform: "YouTube",
		metrics: [
	...
	},
	{
		...
		description: "In-depth articles exploring remote work trends, productivity tools, and workplace evolution",
		type: "Writing",
		platform: "Medium",
		metrics: [
	...
	},
	{
		...
		description: "Instagram series featuring authentic stories from startup founders and entrepreneurs",
		type: "Social",
		platform: "Instagram",
		metrics: [
	...
	},
	{
		...
		description: "Complete rebrand campaign for emerging SaaS company including messaging and visual identity",
		type: "Brand",
...
export default function ArtistPage() {
	...
	const getTypeColor = (type: string) => {
		switch(type) {
			case 'Video': return 'text-red-400 bg-red-600/20';
			case 'Writing': return 'text-blue-400 bg-blue-600/20';
			case 'Social': return 'text-pink-400 bg-pink-600/20';
			case 'Brand': return 'text-purple-400 bg-purple-600/20';
			case 'Campaign': return 'text-green-400 bg-green-600/20';
			...
			<div className="container mx-auto px-4 py-8">
				...
				<div className="text-center mb-12">
					...
					<p className="mt-4 text-lg text-gray-400 max-w-2xl mx-auto">
						Crafting compelling narratives that engage, educate, and inspire audiences across digital platforms
					</p>
				</div>

				{/* Content Pillars */}
				<div className="mb-16">
					<h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Content Philosophy</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
						{contentPillars.map((pillar, index) => (
							<div key={index} className="bg-gray-800/30 p-6 rounded-lg text-center group hover:scale-105 transition-transform duration-300">
								<div className={`w-16 h-16 bg-gradient-to-r ${pillar.color} rounded-full flex items-center justify-center text-white text-2xl mx-auto mb-4`}>
									{pillar.icon}
								</div>
				...
				{/* Creative Projects */}
				<div className="mb-16">
					<h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Creative Projects</h2>
				...
				{/* Skills & Tools */}
				<div className="mb-16">
					<h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Creator Toolkit</h2>
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="bg-gray-800/30 p-6 rounded-lg">
							<h3 className="text-xl font-semibold mb-4 text-purple-400">Content Creation</h3>
						...
						<div className="bg-gray-800/30 p-6 rounded-lg">
							<h3 className="text-xl font-semibold mb-4 text-purple-400">Strategy & Analytics</h3>
							<div className="space-y-3">
								{[
				...
				{/* Creative Process */}
				<div className="mb-16">
					<h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Creative Process</h2>
					<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
						{[
							{ step: "1", title: "Discover", description: "Research audience needs and trending topics" },
							{ step: "2", title: "Ideate", description: "Brainstorm creative concepts and angles" },
							{ step: "3", title: "Create", description: "Produce high-quality, engaging content" },
							{ step: "4", title: "Amplify", description: "Distribute, analyze, and optimize performance" }
						].map((phase, index) => (
				...
				<div className="text-center bg-gradient-to-r from-purple-600/20 to-pink-600/20 p-8 rounded-lg">
					<h2 className="text-3xl md:text-4xl font-bold mb-6">Let's Create Together</h2>
					<p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
						Ready to collaborate on impactful content? I bring creativity, strategy, and technical expertise to every project.
					</p>
				</div>
			</div>
					...
					<div className="bg-gray-900 rounded-lg max-w-2xl w-full p-6" onClick={(e) => e.stopPropagation()}>
						<div className="flex justify-between items-start mb-4">
							<div>
								...
								<span className={`text-xs px-2 py-1 rounded mt-2 inline-block ${getTypeColor(selectedProject.type)}`}>
						...
						<div className="mb-6">
							<h3 className="text-lg font-semibold mb-2 text-purple-400">Platform</h3>
							<span className="text-sm bg-purple-600/20 text-purple-400 px-3 py-1 rounded">
								{selectedProject.platform}
							</span>
						</div>
						<div className="mb-6">
							<h3 className="text-lg font-semibold mb-2 text-purple-400">Metrics</h3>
							<div className="flex flex-wrap gap-2">
								{selectedProject.metrics.map((metric, index) => (
									<span key={index} className="text-sm bg-gray-600/20 text-gray-400 px-3 py-1 rounded">
