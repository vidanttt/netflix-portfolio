      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center bg-gradient-to-r from-purple-600/20 to-pink-600/20 p-8 rounded-lg">
          ...
          <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed mb-6">
            Ready to tell your story? Whether it's building brand awareness, educating your audience, 
            or creating viral content, let's craft something extraordinary that resonates with your community.
          </p>
      ...
      {selectedProject && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50" onClick={() => setSelectedProject(null)}>
          <div className="bg-gray-900 rounded-lg max-w-2xl w-full p-6" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className={`text-xs px-2 py-1 rounded ${getTypeColor(selectedProject.type)}`}>
            ...
            <div className="mb-6">
              <h3 className="text-lg font-semibold mb-3 text-purple-400">Performance Metrics</h3>
              <div className="grid grid-cols-3 gap-4">
                {selectedProject.metrics.map((metric, index) => (
                  <div key={index} className="text-center bg-gray-800/50 p-3 rounded">
